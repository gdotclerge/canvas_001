...
function draw() {
  ...
  ctx.strokeRect(.2*width, 200, .5*width, .5*height);
...
=======
  ctx.fillText("(\uFF61\u25D5\u203F\u203F\u25D5\uFF61)", width*.2, height*.6);
>>>>>>> parent of 5d42b69... made the whole thing look more like a face
